...
namespace EmployeeCRUD.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        {
            var activeInactive = _context.Employees.Find(id);
            if (activeInactive == null)
            {
                return NotFound();
            }
            activeInactive.Is_Active = !activeInactive.Is_Active;
            _context.Employees.Update(activeInactive);
            _context.SaveChanges();
            TempData["ResultOk"] = "Is_Active Record Update Successfully !";
            return Ok();
        }
